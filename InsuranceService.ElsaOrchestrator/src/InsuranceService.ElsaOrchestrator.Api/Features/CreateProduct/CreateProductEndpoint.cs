...
public class CreateProductEndpoint:Endpoint<CalculateServiceRequest, CalculateServiceResponce>
{
    private readonly IStartsWorkflow _workflow;
    private readonly IWorkflowRegistry _registry;
    private readonly IOptions<WorkflowMappings> _mappings;
    public CreateProductEndpoint(IStartsWorkflow workflow, IWorkflowRegistry registry, IOptions<WorkflowMappings> mappings)
    {
        _mappings = mappings;
        _workflow = workflow;
        _registry = registry;
