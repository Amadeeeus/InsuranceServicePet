...
public class RegisterUserEndpoint:Endpoint<CalculateServiceRequest, CalculateServiceResponce>
{
    private readonly IStartsWorkflow _workflow;
    private readonly IWorkflowRegistry _registry;
    private readonly IOptions<WorkflowMappings> _mappings;
    public RegisterUserEndpoint(IStartsWorkflow workflow, IWorkflowRegistry registry, IOptions<WorkflowMappings> mappings)
    {
        _mappings = mappings;
        _workflow = workflow;
        _registry = registry;
